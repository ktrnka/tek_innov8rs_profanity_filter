...
> **Status:** Living planning document — instructor-facing. It lives on `main` alongside the course
> material, but it's notes *for the instructor*, not part of the student brief (students aren't
> expected to read it; it does contain answer-key baselines).
>
